...
?>
<form class="panel form-grid" method="post" action="/admin/guardar-producto.php">
...
<div class="field full"><label>URL de foto</label><input type="url" name="imagen_url" value="<?= Security::e($product['imagen_url'] ?? '') ?>"></div>
