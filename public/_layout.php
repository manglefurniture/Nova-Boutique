...
function pageStart(string $title):void{$cartCount=Cart::count();?>
...
function pageEnd():void{?><footer class="footer"><div class="wrap">Nova Boutique · Proyecto Hache Interactive · Compra responsable, estilo circular.</div></footer></body></html><?php }
