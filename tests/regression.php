...
$must = [
    ...
    'public/admin/producto.php' => ['name="precio"', 'name="stock"', 'name="imagen_url"', 'name="version"'],
    ...
    'src/ProductRepository.php' => ['version=version+1', 'WHERE id=? AND version=?', 'El producto cambió mientras lo editabas'],
